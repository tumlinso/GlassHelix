# GH-NF1-S06: Preserve mechanism provenance under specialization
...
Explicit prerequisites: `GH-NF1-S05`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Map fused, reordered and decomposed numerical stages back to original mechanism and quantity identities; export a queryable view.

## Acceptance and negative control

1. Execution strategy changes preserve scientific descriptions and result alignment.
2. Attention weights, kernel names and layout partitions cannot become molecular mechanism claims.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_s06`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group s06
```
