# GH-NF1-C04: Define observation and inferential-state distinction
...
Explicit prerequisites: `GH-NF1-C03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Represent missingness, modality/time/individual-or-population tags and separate uncertainty updates; no mandatory learned encoder.

## Acceptance and negative control

1. Identical physical state can be paired with different evidence states and vice versa.
2. Measurement zero cannot mean missing; destructive snapshots cannot be treated as individual consecutive states.
...
- `docs/native_foundation_v1/records/gh-nf1-c04.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-C04
```
