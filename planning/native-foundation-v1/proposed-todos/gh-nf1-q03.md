# GH-NF1-Q03: Materialize bounded scaled sensitivity for small diagnostics
...
Explicit prerequisites: `GH-NF1-Q02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Build a small selected sensitivity matrix with explicit parameter and observation scales and independent finite-difference verification.

## Acceptance and negative control

1. Unit changes under an equivalent scaling convention preserve the diagnostic meaning.
2. Unscaled heterogeneous parameters cannot yield an unlabeled rank conclusion.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_q03`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group q03
```
