# GH-NF1-P04: Add capability and plan introspection
...
Explicit prerequisites: `GH-NF1-P03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Expose numerical policy, selected candidates, unsupported features, generation provenance and explicit transfer counters.

## Acceptance and negative control

1. Python can distinguish missing capabilities from empty numerical results.
2. Capability names cannot stand in for an implemented device route.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_p04`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group p04
```
