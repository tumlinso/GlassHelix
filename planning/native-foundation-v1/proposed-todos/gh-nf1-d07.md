# GH-NF1-D07: Qualify transition library and extension boundaries
...
Explicit prerequisites: `GH-NF1-D06`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Run maps, ODE steps, forcing and checkpoint tests on the linked CPU/CUDA path.

## Acceptance and negative control

1. Initial memoryless deterministic regime works while history/stochastic requirements fail transparently.
2. No fake implementation of unsupported DDE/SDE or unrestricted universal simulator is included.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_d07`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group d07
```
