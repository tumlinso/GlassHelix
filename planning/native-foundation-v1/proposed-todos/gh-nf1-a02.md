# GH-NF1-A02: Map both repositories and agentic authorities
...
Explicit prerequisites: `GH-NF1-A01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Discover repository roots/UUIDs, first-class lane and dispatch services, active claims, GPU resources and peer integration policy.

## Acceptance and negative control

1. One launched GlassHelix controller has project-qualified control records for both NF1 runs.
2. No cross-project parent-lane fiction, nested stale Cellerator gitlink or local worker masquerading as a first-class lane.
...
- `docs/native_foundation_v1/records/gh-nf1-a02.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-A02
```
