# GH-NF1-D05: Retain checkpointable primal generations
...
Explicit prerequisites: `GH-NF1-D04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Support bounded rollout checkpoints and provenance needed by reverse calculations; separate numerical step, accepted generation and asynchronous completion.

## Acceptance and negative control

1. Changing parameters after rollout invalidates stale response requests.
2. Current values cannot be substituted for historical primal values without recorded recomputation.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_d05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group d05
```
