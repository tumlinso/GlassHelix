# GH-NF1-S07: Qualify shared and custom systems
...
Explicit prerequisites: `GH-NF1-S06`, `GH-NF1-X03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Validate separate native custom block, common-submechanism alternatives and independent state/candidate batches.

## Acceptance and negative control

1. Extending an evaluator does not require rewriting GlassHelix state or observation machinery.
2. Undeclared global coupling prevents independent batching rather than silently changing the system.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_s07`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group s07
```
