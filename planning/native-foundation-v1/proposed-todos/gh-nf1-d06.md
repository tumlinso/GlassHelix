# GH-NF1-D06: Add guarded numerical validation paths
...
Explicit prerequisites: `GH-NF1-D05`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Track integration approximation, sensitivity alarms and requested precision; provide explicit high-precision reference comparison for qualification.

## Acceptance and negative control

1. Sensitive threshold outcomes can be reported numerically unresolved.
2. Precision escalation alone is not advertised as a proof of biological robustness.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_d06`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group d06
```
