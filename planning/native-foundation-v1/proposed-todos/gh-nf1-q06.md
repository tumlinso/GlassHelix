# GH-NF1-Q06: Expose selected higher-order response and status
...
Explicit prerequisites: `GH-NF1-Q05`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Forward supported second-direction requests to Cellerator and annotate unsupported/nonsmooth cases and approximation conventions.

## Acceptance and negative control

1. A smooth polynomial fixture agrees with independent analytic second response.
2. Differentiating a fitted function repeatedly is not new experimental evidence.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_q06`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group q06
```
