# GH-NF1-E02: Propagate candidates through the same execution path
...
Explicit prerequisites: `GH-NF1-E01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Reuse common definitions/support while keeping independent candidate states, parameters and numerical provenance.

## Acceptance and negative control

1. Candidate propagation agrees with individually executed systems and shares only legal preparation.
2. Candidate alternatives are not population multiplicity and cannot be pooled as biological samples.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_e02`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group e02
```
