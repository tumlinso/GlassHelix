# GH-NF1-C06: Define capability-based extensions
...
Explicit prerequisites: `GH-NF1-C05`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Represent deterministic or future stochastic transitions, optional history and custom blocks as capabilities without implementing universal solver families.

## Acceptance and negative control

1. Unsupported histories, stochastic execution and derivatives fail explicitly.
2. No empty placeholder class is allowed to masquerade as an implemented capability.
...
- `docs/native_foundation_v1/records/gh-nf1-c06.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-C06
```
