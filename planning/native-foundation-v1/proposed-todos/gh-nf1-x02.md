# GH-NF1-X02: Import linked core execution capability
...
Explicit prerequisites: `GH-NF1-X01`. Earlier entries in the lane queue also apply.

External prerequisite: `cellerator::CE-NF1-M20` through `NF1-CE-CORE`. This is verified by this local task, not a native foreign-task dependency.

## Objective and implementation direction

Verify CE-NF1-M20 with executable general-width/f32 and shared value-instance evidence.

## Acceptance and negative control

1. Consumer pins an integrated compatible Cellerator source revision.
2. N1/N16 declarations or f16-only old path cannot satisfy general execution capability.
...
```sh
python3 -B planning/native-foundation-v1/scripts/verify_receipt.py --edge NF1-CE-CORE
```
