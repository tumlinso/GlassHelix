# GH-NF1-T03: Author response, null and support counterexamples
...
Explicit prerequisites: `GH-NF1-T02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Include a+b ambiguity, zero primal/nonzero derivative, false conditional with nonfinite operand and invalid local-reduction cases.

## Acceptance and negative control

1. Correct outputs and correct refusal modes are specified before implementation.
2. Numerical nulls, trainable zeros and masked NaNs cannot be conflated.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_t03`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group t03
```
