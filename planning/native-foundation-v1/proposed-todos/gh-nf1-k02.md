# GH-NF1-K02: Measure setup, resident and result-observation cost
...
Explicit prerequisites: `GH-NF1-K01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Record preparation, uploads, dynamic values, integration, observation, response, downloads, memory and launch counters.

## Acceptance and negative control

1. Reuse benefits and cold penalties remain independently visible.
2. Excluded phases cannot be hidden inside a claimed universal speedup.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_k02`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group k02
```
