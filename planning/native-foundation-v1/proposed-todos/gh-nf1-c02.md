# GH-NF1-C02: Define system, mechanism and instance semantics
...
Explicit prerequisites: `GH-NF1-C01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Separate immutable scientific definitions from numerical realization and independently bound state/parameters; preserve n-ary argument roles.

## Acceptance and negative control

1. Shared definitions can produce independent instances with different values.
2. Kernel fusion or splitting cannot change the declared biological mechanism boundary.
...
- `docs/native_foundation_v1/records/gh-nf1-c02.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-C02
```
