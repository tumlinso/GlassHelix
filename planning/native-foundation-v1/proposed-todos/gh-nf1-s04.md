# GH-NF1-S04: Bind independent dynamical and parameter instances
...
Explicit prerequisites: `GH-NF1-S03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Allocate or borrow state through Cellerator lifetimes, keep parameter tying explicit and allow common structure with separate values.

## Acceptance and negative control

1. Two candidates share preparation and retain different values without contamination.
2. Shared initial data cannot imply shared mutable parameters or beliefs.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_s04`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group s04
```
