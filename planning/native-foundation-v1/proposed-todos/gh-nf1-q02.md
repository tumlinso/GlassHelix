# GH-NF1-Q02: Compose matrix-free observation-history sensitivity
...
Explicit prerequisites: `GH-NF1-Q01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Apply JVP/VJP through saved or recomputed primal stages and observations without compulsory dense Jacobians.

## Acceptance and negative control

1. Adjoint consistency holds for selected outputs and parameter directions.
2. Parameter changes, activity changes and unsupported custom blocks invalidate or reject the response.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_q02`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group q02
```
