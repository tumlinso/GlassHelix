# GH-NF1-K03: Test sharing and compact-support profitability

Status on delivery: **planned**, not claimed or implemented.
Project: `glasshelix`. First-class lane: `GH-NF1-L-K`. Workspace: isolated_merge.
Explicit prerequisites: `GH-NF1-K02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Compare independent instances with shared definitions/structure and verify differential-support correctness in reduced work.

## Acceptance and negative control

1. Common support is prepared once where valid and measured compaction wins only in admitted regimes.
2. Candidate state or parameter contamination invalidates performance results regardless of speed.
...
- `docs/native_foundation_v1/performance`
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_k03`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group k03
```
