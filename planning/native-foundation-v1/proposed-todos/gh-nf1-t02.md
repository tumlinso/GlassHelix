# GH-NF1-T02: Author role and observation counterexamples
...
Explicit prerequisites: `GH-NF1-T01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Cover state-versus-observation, missing-versus-zero, population-versus-history and reporter-correlation distinctions.

## Acceptance and negative control

1. Each counterexample fails under the prohibited conflation.
2. A visually plausible latent space is not accepted as the test result.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_t02`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group t02
```
