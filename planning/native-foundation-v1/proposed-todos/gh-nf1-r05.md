# GH-NF1-R05: Qualify reduction/inference separation
...
Explicit prerequisites: `GH-NF1-R04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Show that computational slicing, physical quotienting and measurement usefulness remain distinct in executable fixtures.

## Acceptance and negative control

1. Reporter information needed for later inference survives physical output reduction.
2. Compression must not delete lineage/entity multiplicity or evidence distinguishing mechanisms.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_r05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group r05
```
