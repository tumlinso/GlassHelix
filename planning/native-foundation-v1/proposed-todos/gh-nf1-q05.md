# GH-NF1-Q05: Compare aligned candidate mechanisms and joint alternatives
...
Explicit prerequisites: `GH-NF1-Q04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Report shared response features and mutually exclusive unresolved branches without inventing a hybrid edge-wise mechanism.

## Acceptance and negative control

1. Two supplied alternatives retain joint identity while common submechanism roles remain inspectable.
2. Counting parameterizations is not a probability over mechanisms.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_q05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group q05
```
