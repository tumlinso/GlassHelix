# GH-NF1-Q01: Expose the derivative of the requested calculation
...
Distinguish vector field, map, RK4 step, observation and rollout response; bind state/parameter/forcing directions to current primal evidence.

## Acceptance and negative control

1. Diagnostics identify which mathematical object was differentiated.
2. A derivative of the implemented step is not advertised as the exact continuous flow derivative.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_q01`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group q01
```
