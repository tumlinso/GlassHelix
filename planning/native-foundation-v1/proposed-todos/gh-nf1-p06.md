# GH-NF1-P06: Publish native/Python parity and packaging evidence
...
Explicit prerequisites: `GH-NF1-P05`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Execute equivalent forced rollouts, observations and null diagnostics through both interfaces and a fresh environment.

## Acceptance and negative control

1. Missing extensions and mismatched dependency revisions fail clearly.
2. Python success via a separate reference implementation cannot satisfy native parity.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_p06`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group p06
```
