# GH-NF1-U04: Bind evidence and peer revision in artifacts
...
Explicit prerequisites: `GH-NF1-U03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Record both source revisions, interface digests, exact execution policy and optional grounding references in run artifacts.

## Acceptance and negative control

1. Replay can report whether a changed build is equivalent, revalidated or incompatible.
2. A newer Cellerator checkout is not automatically substituted for the qualified dependency.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_u04`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group u04
```
