# GH-NF1-M40: Python, artifacts and post-epic demonstration integrated
...
Explicit prerequisites: `GH-NF1-M30`, `GH-NF1-P06`, `GH-NF1-U06`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Integrate the prerequisites onto the designated integration branch, rebuild the real linked path and verify the checkpoint contract. Complete native demo, Python parity and replay work without a separate numerical model implementation.

## Acceptance and negative control

1. Complete native demo, Python parity and replay work without a separate numerical model implementation.
...
Evidence kind: **integrated_executed_tests**. Required CTest names: `gh_nf1_demo_cpu`, `gh_nf1_demo_cuda`, `gh_nf1_python_parity`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group m40
```
