# GH-NF1-A03: Review legacy source and replacement boundaries
...
Explicit prerequisites: `GH-NF1-A02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Classify GlassEtch build, token Cell, sparse helpers and old data scripts as history or selectively reusable pieces; select new native build ownership.

## Acceptance and negative control

1. A source disposition names what is retained, retired from default build or reused after testing.
2. No reset/clean of user work or restoration of pairwise masked reconstruction as causal doctrine.
...
- `docs/native_foundation_v1/records/gh-nf1-a03.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-A03
```
