# GH-NF1-M10: Native contracts and first external consumer integrated
...
Explicit prerequisites: `GH-NF1-M00`, `GH-NF1-C07`, `GH-NF1-B05`, `GH-NF1-S03`, `GH-NF1-X02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Integrate the prerequisites onto the designated integration branch, rebuild the real linked path and verify the checkpoint contract. A separately linked GlassHelix library executes a simple real Cellerator-backed calculation.

## Acceptance and negative control

1. A separately linked GlassHelix library executes a simple real Cellerator-backed calculation.
...
Evidence kind: **integrated_executed_tests**. Required CTest names: `gh_nf1_external_consumer_cpu`, `gh_nf1_external_consumer_cuda`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group m10
```
