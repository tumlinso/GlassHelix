# GH-NF1-C05: Define numerical and interpretation provenance
...
Explicit prerequisites: `GH-NF1-C04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Separate exact model identity, model assumptions, prior constraints, empirical support, numerical approximations and biological labels.

## Acceptance and negative control

1. Result records retain units/scales, numerical policy and source/model generations.
2. Approximation, inference uncertainty and mechanism ambiguity cannot collapse into a single unlabeled confidence scalar.
...
- `docs/native_foundation_v1/records/gh-nf1-c05.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-C05
```
