# GH-NF1-O05: Compose observation response with dynamics
...
Explicit prerequisites: `GH-NF1-O04`, `GH-NF1-X04`, `GH-NF1-D07`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Use Cellerator differential programs for the requested observation of a state or rollout, preserving observation parameter and state generations.

## Acceptance and negative control

1. Composed observation JVP/VJP match an independently differentiated fixture.
2. Vector-field Jacobian cannot substitute for the observation-history sensitivity.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_o05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group o05
```
