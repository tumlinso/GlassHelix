# GH-NF1-K05: Qualify sensitivity-aware performance and final report
...
Explicit prerequisites: `GH-NF1-K04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Run serial uncontaminated timing with the shared host lock and actual GPU lease; report distributions, tolerances, source and dependency bundle.

## Acceptance and negative control

1. Final evidence separates speed, error, statistical uncertainty and mechanism ambiguity.
2. Precision-sensitive branch outcomes cannot be dismissed as mere throughput noise.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_k05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group k05
```
