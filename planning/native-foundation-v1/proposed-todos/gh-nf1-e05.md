# GH-NF1-E05: Qualify inference as an instrument not a learner
...
Explicit prerequisites: `GH-NF1-E04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Exercise deterministic propagation and evidence updates with supplied candidates and external labels.

## Acceptance and negative control

1. No optimizer, learned encoder, resampling policy or mechanism search is necessary to run the fixture.
2. Inferential success is not misreported as de novo hidden mechanism discovery.
...
Evidence kind: **executed_cuda_test**. Required CTest names: `gh_nf1_e05`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group e05
```
