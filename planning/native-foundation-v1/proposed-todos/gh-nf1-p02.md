# GH-NF1-P02: Define explicit host array ingress and conversion
...
Explicit prerequisites: `GH-NF1-P01`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Preserve shapes, strides, dtype, identity and owner lifetime; reject implicit conversion when exact no-copy input is requested.

## Acceptance and negative control

1. Noncontiguous and wrong-dtype arrays either fail clearly or use an explicitly requested copy.
2. No hidden normalization or preprocessing policy enters the native toolbox.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_p02`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group p02
```
