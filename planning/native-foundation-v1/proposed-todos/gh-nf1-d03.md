# GH-NF1-D03: Represent zero and scheduled forcing
...
Explicit prerequisites: `GH-NF1-D02`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Bind forcing values with stage-evaluation times, units and known discontinuity boundaries; support forced/unforced calls on the same system.

## Acceptance and negative control

1. Piecewise forcing changes happen at declared boundaries and stage times.
2. Unknown environmental input cannot silently default to an asserted biological zero.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_d03`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group d03
```
