# GH-NF1-C07: Publish developmental GlassHelix contracts
...
Explicit prerequisites: `GH-NF1-C06`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Freeze only next-fanout contracts, reconcile prospective example spelling against the executable semantics and record coordinated revision procedure.

## Acceptance and negative control

1. Native, observation, inference and diagnostic roles share one coherent specification.
2. Demo API sketch can be improved with source/consumer updates; acceptance meaning cannot be weakened.
...
- `docs/native_foundation_v1/records/gh-nf1-c07.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-C07
```
