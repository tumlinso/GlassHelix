# GH-NF1-M00: Scope, control and baseline adopted
...
Explicit prerequisites: `GH-NF1-A04`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Integrate the prerequisites onto the designated integration branch, rebuild the real linked path and verify the checkpoint contract. Accept toolbox-only scope, autonomy charter, source disposition and both project identities.

## Acceptance and negative control

1. Accept toolbox-only scope, autonomy charter, source disposition and both project identities.
...
- `docs/native_foundation_v1/records/gh-nf1-m00.json`
...
```sh
python3 -B planning/native-foundation-v1/scripts/check_record.py --milestone GH-NF1-M00
```
