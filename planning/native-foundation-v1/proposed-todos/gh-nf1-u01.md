# GH-NF1-U01: Implement capability and plan explanation
...
Explicit prerequisites: `GH-NF1-M20`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Provide native tools to list implemented operations, selected realization, numerical policy, preparation cost and rejection reasons.

## Acceptance and negative control

1. Requested unsupported capabilities produce actionable explicit diagnostics.
2. Operation schemas and planner proposals cannot be reported as linked execution support.
...
Evidence kind: **executed_host_test**. Required CTest names: `gh_nf1_u01`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group u01
```
