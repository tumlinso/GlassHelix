# GH-NF1-M20: Shared nonlinear transition toolbox integrated
...
Explicit prerequisites: `GH-NF1-M10`, `GH-NF1-S07`, `GH-NF1-D07`, `GH-NF1-X03`. Earlier entries in the lane queue also apply.

## Objective and implementation direction

Integrate the prerequisites onto the designated integration branch, rebuild the real linked path and verify the checkpoint contract. Deterministic maps and forced RK4 run n-ary systems with shared definitions and independent instances.

## Acceptance and negative control

1. Deterministic maps and forced RK4 run n-ary systems with shared definitions and independent instances.
...
Evidence kind: **integrated_executed_tests**. Required CTest names: `gh_nf1_shared_transition_cuda`.

```sh
python3 -B planning/native-foundation-v1/scripts/run_gate.py --group m20
```
